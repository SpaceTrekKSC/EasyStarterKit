/************************************************* ************************************************** ******
* OPEN-SMART Easy Starter Kit Lesson 15: Number flashing
*
...
#define TOUCH_OUT4 12//out4-TCH4 area corresponds to make it enter settimg number mode and the number will flash("next step button")
...
int num = 2019;// the initial value of the number
